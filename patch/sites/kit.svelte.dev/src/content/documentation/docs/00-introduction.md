...
Создание приложения со всеми современными передовыми практиками — разделение кода, [оффлайн поддержка](#servis-vorkery), [серверный рендеринг](#prilozhenie-ssr) с [гидрация на стороне клиента](#prilozhenie-hydration) — дьявольски сложно. SvelteKit делает все скучное за вас, чтобы вы могли продолжать творческую часть.
