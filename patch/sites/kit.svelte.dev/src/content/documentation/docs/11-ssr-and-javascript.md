...
Если хотя бы некоторые страницы не содержат динамических или пользовательских данных, то они могут быть предварительно отрисованы выбранным [адаптером](#adaptery).
